...
| `CACHE_BYTE_BUDGET` | `33554432` | Delivery cache size cap, in bytes. Entries are **never time-evicted**; freshness rests entirely on Control Plane invalidation (both planes share one in-process cache handle) |
